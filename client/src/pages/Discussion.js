      ...
      <div className="discussion">
        <div className="discussion__container">
          <div className="discussion__header">
            <img
              className="info-icon"
              src={require("../images/discuss_icon.png")}
              alt="Discussion"
            />
          ...
          <div className="discussion__item">
            <div className="discussion__subitem">
              ...
              <div className="discussion__subitem-aside">
                <a href="#">
                  <img
                    src={require("../images/bookmark_icon.png")}
                    className="info-icon"
                    alt="Bookmark"
                  />
                </a>
          ...
          <div className="discussion__item">
            <div className="discussion__subitem">
              <ul>
                <li>
                  <img src={require("../images/card_1.png")} alt="" />
                </li>
                <li>
                  <img src={require("../images/card_2.png")} alt="" />
                </li>
                <li>
                  <img src={require("../images/card_3.png")} alt="" />
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="discussion__item">
            <div className="discussion__message">
              <div className="discussion__message-card">
                ...
                <p className="discussion__message-text">
                  I started collecting sports cards on this platform about 8
                  months ago. Last week, I purchased these 3 baseball cards to
                  add to my portfolio, and they've gone up 8% in value! Sweet.
                  (P.s. I'm currently selling 2 exclusive basketball cards,
                  checkout my profile for more info).
                </p>
              </div>
              ...
              <div className="discussion__message-card">
                <div className="discussion__message-nav">
                  <div className="discussion__message-btn">
                    <a href="#">
                      <img
                        src={require("../images/icon_arrow_up.png")}
                  ...
                  <div className="discussion__message-btn">
                    <a href="#">
                      <img
                        src={require("../images/icon_arrow_down.png")}
                        className="iconMessage"
                        alt="Downvotes"
                      />
                    </a>
                  ...
                  <div className="discussion__message-btn">
                    <a href="#">
                      <img
                        src={require("../images/icon_message.png")}
                        className="iconMessage"
                        alt="Comments"
                      />
                    </a>
                  ...
                  <div className="discussion__message-btn">
                    <a href="#">
                      <img
                        src={require("../images/icon_share.png")}
                        className="iconMessage"
                        alt="Share"
                      />
                    </a>
